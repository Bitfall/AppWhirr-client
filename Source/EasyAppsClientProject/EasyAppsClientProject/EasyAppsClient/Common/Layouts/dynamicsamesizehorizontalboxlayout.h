...
class DynamicSameSizeHorizontalBoxLayout : public DynamicDelegateBasedHighPerformanceSameSizeLayoutBase
{
    Q_OBJECT
public:
    explicit DynamicSameSizeHorizontalBoxLayout(WidgetListSnapshotHandlerDelegate *snapshotHandlerDelegate, SameSizeLayoutSnapshotChangeDelegateBase *layoutSnapshotChangeDelegate, QSize itemSize, QWidget *parent = 0);
