...
//    void requestForInitialPageDescription();
    void requestForApplication(QString applicationID);
    void requestForGrabbingApplication(QString applicationID);
    void requestForLoggingUserIn();
//    void requestForGrabbingApplicationByAppId(QString applicationID, GrabRequestType grabType);
    void requestForUserGrabList();
    void requestForClientUpdateVersionCheck();
    void requestForClientUpdateZip();
    void requestForUserFeedback(QString feedbackMessage);
    void requestForUserSuggestAnApp(QString name, QString website, QString summary);

    void performThisRequest(AW::Common::Communication::BaseNetworkRequest *requestToPerform);

Q_SIGNALS:
    void failedToRetrieveDescription(QString errorMessage);
    //
    ...
    void finished(QList<AW::Common::Communication::BaseNetworkEntity *> entities);
    //
...
private Q_SLOTS:
    ...
    void requestFailed();
    void requestReceived(QByteArray response, bool isBufferDownloadedResourceAndSendItWhenDownloadFinished);
...
private:
    AW::Common::Communication::BaseNetworkRequest*                  networkRequest;
    AW::Common::Communication::Background_BaseNetworkResponse*        networkResponse;
