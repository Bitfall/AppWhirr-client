...
class ApplicationListWithSectionsNetworkEntity : public AW::Common::Communication::BaseNetworkEntity
{
    Q_OBJECT
public:
//    // --------------------------
...
//    };
    ...
    public:
        ...
        explicit ApplicationListSectionModel(QString sectionTitle, QString sectionBackgroundImageUrl, QString sectionIdentifier="");
        ...
        QString getSectionIdentifier() const;
        bool isEmpty() const;
