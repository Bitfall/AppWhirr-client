...
//    DLog("Service pack name: ") << osvi.szCSDVersion;
    ...
    PlatformFlagsHelper::WinSubFlags winSubFlag = PlatformFlagsHelper::Win_XP_NoSP;
...
//bool SystemProfiler::isThisSummedFlagCompatibleWithThisPlatform(QString summedFlags) {
//    QString systemFlagsAsString = PlatformFlagsHelper::_convertIntBasedFlagsToStringBased(_getSystemFlagsAsUInt());
//    return PlatformFlagsHelper::isTheseFlagsAreCompatible(systemFlagsAsString, summedFlags);
//}
